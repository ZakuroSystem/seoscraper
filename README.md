...
ブラウザで [http://localhost:5000](http://localhost:5000) にアクセスしてください。フォームから遅延やワーカー数、解析モード、除外パターンなどすべての主要機能を直感的に設定できます。検索実行後の結果はフォームより上部に表示され、本文は50文字まで表示されます。クリックすると全文が展開されます。
